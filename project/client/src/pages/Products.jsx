       ...
       <div className="row">
          ...
          <div className="col-sm-6 col-md-4 col-lg-4">
             <div className="box">
                ...
                <div className="img-box">
                   <img src="/public/assets/images/p5.png" alt="" />
                </div>
                <div className="detail-box">
                   <h5>
                      Women's Dress
          ...
          <div className="col-sm-6 col-md-4 col-lg-4">
             <div className="box">
                ...
                <div className="img-box">
                   <img src="/public/assets/images/p9.png" alt="" />
                </div>
                <div className="detail-box">
                   <h5>
                      Men's Shirt
          ...
          <div className="col-sm-6 col-md-4 col-lg-4">
             <div className="box">
                ...
                <div className="img-box">
                   <img src="/public/assets/images/p10.png" alt="" />
                </div>
                <div className="detail-box">
                   <h5>
                      Men's Shirt
          ...
          <div className="col-sm-6 col-md-4 col-lg-4">
             <div className="box">
                ...
                <div className="img-box">
                   <img src="/public/assets/images/p11.png" alt="" />
                </div>
                <div className="detail-box">
                   <h5>
                      Men's Shirt
          ...
          <div className="col-sm-6 col-md-4 col-lg-4">
             <div className="box">
                ...
                <div className="img-box">
                   <img src="/public/assets/images/p12.png" alt="" />
                </div>
                <div className="detail-box">
                   <h5>
                      Women's Dress
